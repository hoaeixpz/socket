...
print(obj.m_dAssetBalance)
print(obj.m_dAssureAsset)
print(obj.m_dAvailable)
print(obj.m_dBalance)
print(obj.m_dBuyWaitMoney)
print(obj.m_dCashIn)
print(obj.m_dCloseProfit)
print(obj.m_dCommission)
print(obj.m_dCredit)
print(obj.m_dCurrMargin)
print(obj.m_dDeposit)
print(obj.m_dEntrustAsset)
print(obj.m_dFetchBalance)
print(obj.m_dFrozenCash)
print(obj.m_dFrozenCommission)
print(obj.m_dFrozenMargin)
print(obj.m_dFrozenRoyalty)
print(obj.m_dFundValue)
print(obj.m_dGoldFrozen)
print(obj.m_dGoldValue)
print(obj.m_dInitBalance)
print(obj.m_dInitCloseMoney)
print(obj.m_dInstrumentValue)
print(obj.m_dInstrumentValueRMB)
print(obj.m_dIntradayBalance)
print(obj.m_dIntradayFreedBalance)
print(obj.m_dLoanValue)
print(obj.m_dLongValue)
print(obj.m_dMargin)
print(obj.m_dMaxMarginRate)
print(obj.m_dMortgage)
print(obj.m_dNav)
print(obj.m_dNetValue)
print(obj.m_dOccupiedBalance)
print(obj.m_dPositionProfit)
print(obj.m_dPreBalance)
print(obj.m_dPreCredit)
print(obj.m_dPreMortgage)
print(obj.m_dPurchasingPower)
print(obj.m_dRawMargin)
print(obj.m_dRealRiskDegree)
print(obj.m_dRealUsedMargin)
print(obj.m_dReceiveInterestTotal)
print(obj.m_dRepurchaseValue)
print(obj.m_dRisk)
print(obj.m_dRoyalty)
print(obj.m_dSellWaitMoney)
print(obj.m_dShortValue)
print(obj.m_dStockValue)
print(obj.m_dSubscribeFee)
print(obj.m_dTotalDebit)
print(obj.m_dWithdraw)
print(obj.m_nBrokerType)
print(obj.m_nDirection)
print(obj.m_strAccountID)
print(obj.m_strAccountKey)
print(obj.m_strAccountRemark)
print(obj.m_strBrokerName)
print(obj.m_strMoneyType)
print(obj.m_strOpenDate)
print(obj.m_strStatus)
print(obj.m_strTradingDate)
