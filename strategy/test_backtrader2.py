...
def real_data():
    df = stock_price.get_stock_hfq_price("002278")
...
start_date = datetime(2019,12,31)  # 回测开始时间
end_date = datetime(2020,12,31)  # 回测结束时间
...
cerebro.addstrategy(SimpleBuyAndHoldStrategy)  # 将交易策略加载到回测系统中
# 加入pyfolio分析者
